function A = Jacobian_computation(x1, y1, x6, y6, x9, y9, x15, y15, w1, w6, w9, w15, X_0)
    ...
    J = jacobian(L_sym,[x1, y1, x6, y6, x9, y9, x15, y15, w1, w6, w9, w15]);
    A = subs(J, [x1, y1, x6, y6, x9, y9, x15, y15, w1, w6, w9, w15],X_0');
end
