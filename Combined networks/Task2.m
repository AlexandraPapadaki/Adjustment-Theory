...
L_0(14) = direction (y9, x9, y15, x15, w15); 
    ...
    %Designmatrix
    %  xfrom,yfrom,  xto,yto
    % target an from fixed
    % origin an from unknown points
    %origin/target from unknown to unknown for derivative of the same point or the meansioned as target for the measurement...see s151 
...
% xfrom,yfrom,  xto,yto
    % target an from fixed
    % origin an from unknown points
     %origin/target from unknown to unknown for derivative of the same point or the
     %mensioned as target for the measurement...see 115
